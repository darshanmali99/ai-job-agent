...
READ-ONLY MODE: Safely reads from jobs_dataset.csv without modifying production pipeline
"""
...
def main():
    ...
    if df.empty:
        ...
        st.info("💡 Wait for GitHub Actions to populate data")
        st.stop()
